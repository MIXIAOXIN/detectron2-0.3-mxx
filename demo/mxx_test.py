...
if __name__ == '__main__':
    input_path = "/home/mxx/Data/test_input.jpg" # avoid test image in the current project directory, otherwise it should be push to the github resposity
    output_path = "/home/mxx/Data/result_instance_segmentation.jpg"
    ...
    model_weights = "./../pretrain-model/model_final_f10217.pkl"
    ...
    cv2.imshow('instance_result', result)
    cv2.waitKey(0)